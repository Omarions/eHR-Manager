...
public class Constants {
    ...
    public static final Path RESOURCE_PATH = FileSystems.getDefault().getPath("photos").toAbsolutePath();
    ...
    public static final Image Exit_MENU_ICON 
     ...
     public static final Image EMP_ICON 
            = new Image(Constants.class.getResourceAsStream("/images/aboutme-32.png"));
